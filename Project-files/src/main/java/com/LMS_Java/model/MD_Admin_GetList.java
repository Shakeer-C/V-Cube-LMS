...
public class MD_Admin_GetList {
	...
	public String toString() {
		return "MD_Admin_GetList [stId=" + stId + ", stName=" + stName + ", stEmail=" + stEmail + ", stMobile="
				+ stMobile + ", stPsw=" + stPsw + ", stCpsw=" + stCpsw + ", bname=" + bname + ", crId=" + crId
				+ ", stType=" + stType + ", sMock=" + sMock + ", sWkTst=" + sWkTst + ", batchCount=" + batchCount
				+ ", teacherCount=" + teacherCount + ", studentsCount=" + studentsCount + ", acMockCount=" + acMockCount
				+ ", acWktstCount=" + acWktstCount + ", bStudentCount=" + bStudentCount + ", conTitle=" + conTitle
				+ ", conDisp=" + conDisp + ", conMetiral=" + conMetiral + ", conAssig=" + conAssig + "]";
	}
